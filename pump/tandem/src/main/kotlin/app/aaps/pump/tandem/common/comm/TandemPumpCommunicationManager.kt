...
class TandemPumpCommunicationManager(
    ...
    @Volatile private var handshakingStartTime: Long = 0L
    ...
    private fun tearDownBluetoothHandler() {
        // Fully tear down the BLE handler: cancel any live peripheral
        // connection, stop the central, and clear communication state.
